...
import img from '../assets/images/blackjack.png'
            ...
            <div className="container pt-5">
                <div className="row">
                    <div className="col-md-6 text-center m">
                        <h2 className="about_sec_head mb-5">About <span className='mini'>Me</span></h2>
                    ...
                    <div className="col-md-6">
                        <div className="about_sec_text">
                            ...
                            <div className="about_icons mb-2"><i className="fa fa-code"></i><span className="ms-2 fw-bold">Learnind
                                Curve</span></div>
                            <p className="mb-4">
                                I have a deep passion for <strong> cybersecurity</strong> and aspire to become an expert in the 
                                field while establishing my own tech company in the future.
                            </p>
